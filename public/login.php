...
if (isset($_POST['email'])) {
    ...
    $errores = false;
    if (!Utilidades::longitudCadenaValida('pass', $pass, 5, 12)) {
        $errores = true;
    }
    ...
    if (!$errores) {
        if (!Utilidades::loginValido($email, $pass)) {
            $errores = true;
        }
    }
    ...
    //si estoy aqui es por que todo ha ido bien
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="POST">
                        ...
                        <div>
                            ...
                            Utilidades::pintarError('err_login');
                            ?>
                        </div>
                        <button type="submit"
